...
# 找到前10个最匹配的段落
def find_top_matches(drawing_coords, hcn_coords, hcn_coords_norm, window_size=100, top_n=10, threshold=None):
    top_matches = []
...
if __name__ == "__main__":
    similarity_threshold = 5000  # 设置相似度阈值

    # 找到前10个最匹配的段落
    top_matches = find_top_matches(drawing_coords_norm, hcn_coords, hcn_coords_norm, threshold=similarity_threshold)
